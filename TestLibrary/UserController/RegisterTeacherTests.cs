...
namespace MLP_TestLibrary.UserController
{
    ...
    public class RegisterTeacherTests
    {
        ...
        public void Register_Teacher_Succeeds(string emailToLogin, string passwordToLogin, string email, string password, string firstName, string lastName, bool isTeacher, bool isAdmin)
        {
            ...
            var responseTeacher = authenticateResponse.GetContent<ResponseAuthenticationDTO>();
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(teacher.Id == responseTeacher.Id, "Id is correct after authentication");
                Assert.That(responseTeacher.PersonType == PersonType.Teacher, "Correct persontype");
